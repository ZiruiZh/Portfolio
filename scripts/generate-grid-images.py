...
of that. Each project cover reel also gets a poster from its first frame, so a
...
# Project stills shown on a mat in the visual grid never render wider than a column.
PROJECT_STILLS = ['artsfest-1.webp']
